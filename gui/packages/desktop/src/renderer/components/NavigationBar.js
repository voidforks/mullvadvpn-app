...
export default class NavigationBar extends Component {
  render() {
    return <View style={[styles.navigationBar.default, styles.navigationBar[process.platform]]}>
        {this.props.children}
      </View>;
  }
}
...
export class CloseBarItem extends Component {
  ...
  render() {
    return <Button style={[styles.closeBarItem.default]} onPress={this.props.action}>
...
export class BackBarItem extends Component {
  ...
  render() {
    return <Button style={styles.backBarButton.default} onPress={this.props.action}>
