...
export default class Connect extends Component /*:: <Props, State>*/ {
  ...
  shouldComponentUpdate(nextProps /*: Props*/, nextState /*: State*/) {
    ...
    return (
      ...
      !shallowCompare(prevConnection, nextConnection) || !shallowCompare(otherPrevProps, otherNextProps) || prevState.mapOffset[0] !== nextState.mapOffset[0] || prevState.mapOffset[1] !== nextState.mapOffset[1] || prevState.showCopyIPMessage !== nextState.showCopyIPMessage
    );
  }
  ...
  renderError(error /*: Error*/) {
    ...
    return <View style={styles.connect}>
        ...
        <View style={styles.status}>
          ...
          {error instanceof NoCreditError ? <View>
  ...
  renderMap() {
    ...
    return <View style={styles.connect}>
        ...
        <View style={styles.container}>
          ...
          {}
          {isConnecting ? <View style={styles.status_icon}>
          ...
          <View style={styles.status}>
            ...
            {}
            {isConnecting || isDisconnected ? <Text style={styles.status_location} testName="location">
                {this.props.connection.country}
              </Text> : null}

            {}
            {isConnected ? <Text style={styles.status_location} testName="location">
            ...
            <Text style={this.ipAddressStyle()} onPress={this.onIPAddressClick.bind(this)}>
              {isConnected || isDisconnected ? <Text testName="ipAddress">
                  {this.state.showCopyIPMessage ? 'IP copied to clipboard!' : this.props.connection.ip}
                </Text> : null}
            </Text>
          </View>
          ...
          {}
          {isDisconnected ? <View style={styles.footer}>
              <AppButton.TransparentButton style={styles.switch_location_button} onPress={this.props.onSelectLocation}>
          ...
          {}
          {isConnecting ? <View style={styles.footer}>
              <AppButton.TransparentButton style={styles.switch_location_button} onPress={this.props.onSelectLocation}>
                {'Switch location'}
              </AppButton.TransparentButton>
          ...
          {}
          {isConnected ? <View style={styles.footer}>
              <AppButton.TransparentButton style={styles.switch_location_button} onPress={this.props.onSelectLocation}>
                {'Switch location'}
              </AppButton.TransparentButton>
